...
export const personalDetails = mysqlTable("personal_details", {
  ...
  dateStarted: varchar("dateStarted", { length: 100 }), // Changed to varchar for flexible date input
  ...
  incomeCurrency: varchar("incomeCurrency", { length: 3 }).default("AUD"),
  taxableIncome: int("taxableIncome"),
  estimatedSuper: int("estimatedSuper"),
